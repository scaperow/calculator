...
go.GraphObject.defineBuilder('Button', function (args) {
  ...
  var buttonFillNormal = '#f9f9f9';
  var buttonStrokeNormal = '#fff';
  var buttonFillOver = '#2196F3';
  var buttonStrokeOver = '#2196F3';
  var buttonFillPressed = '#3F51B5'; // set to null for no button pressed effects
  var buttonStrokePressed = '#3F51B5';
...
go.GraphObject.defineBuilder('TreeExpanderButton', function (args) {
  var button = /** @type {Panel} */ (
    go.GraphObject.make('CircleButton',
      ...
      //new go.Binding('visible', "", (value, element) => element.part.isSelected && !element.part.isTreeLeaf).ofObject()
...
go.GraphObject.defineBuilder('TreeExpanderLink', function (args) {
  var button = /** @type {Panel} */ (
    go.GraphObject.make('CircleButton',
      go.GraphObject.make(go.Shape,  // the icon
        {
