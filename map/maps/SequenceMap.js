...
import { createTextBlock, makeContextMenu, makeNodeDragable, makeTextEditable, makeOnewayBinding, createIconHolder } from '../helper';
...
function backComputeActivityLocation(loc, act, node, aa) {
    ...
    createTemplate(style, actionList) {
        ...
        return $(MessageLink,  // defined below
            ...
            $(go.Shape, "Rectangle",
                ...
                ...makeOnewayBinding(false, 'stroke', 'strokeDashArray')
            ),
            $(go.Shape,
                {
                    fill: stroke,
                ...
                ...makeOnewayBinding(false, 'stroke', 'toArrow')
            ),

            createTextBlock(style, '消息', {
                segmentIndex: 0,
...
const Sequential = {
    ...
    createTemplate(style, actionList) {
        ...
        return $(go.Group, "Vertical",
            ...
            [
                makeContextMenu(this, actionList),
            ...
            $(go.Shape,
                ...
                [makeOnewayBinding(false, 'fill', 'stroke', 'strokeWidth', 'strokeDashArray')])
        );
    }
}
...
const Activity = {
    ...
    createTemplate(style, actionList) {
        var { fill, stroke, strokeWidth, width, height, radius, strokeDashArray } = style
