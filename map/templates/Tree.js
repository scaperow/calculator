import { createTextBlock, makeOnewayBinding, getPartDargging, makeSelectable, makeTextEditable, layoutRoot, updateNodeDirection, createIconHolder, makeContextMenu, makeTwowayBinding } from '../helper'

// class TreeTitle {
//   category = 'TreeTitle'
//   styleNames = ['fill', 'stroke', 'strokeWidth', 'text', 'fontFamily', 'fontColor', 'fontSize', 'fontBold', 'fontItalic', 'isUnderline', 'isStrikethrough']
//   allowAction = ['delete', 'insertChild']
//   style
...
//    */
//   createTemplate () {
//     return createTreeNode('主题', { ...this.style, fontSize: '24px' }, this.actionList.searchAction(...this.allowAction), {
//       deletable: false
//     })
//   }
// }
...
//   allowAction = ['delete', 'insertChild', 'insertBrother', 'insertParent']
//   style
//   onStartDrag = onStartDrag
//   onDragging = onDragging
//   onStopDrag = onStopDrag
...
//    */
//   createTemplate () {
//     return createTreeNode('子主题', { ...this.style, fontSize: '18px' }, this.actionList.searchAction(...this.allowAction))
//   }
// }
...
const onDragging = function (firstSelection, diagram) {
  let { part, parent, direction } = findNearParts(diagram, firstSelection)
  var dir = null
  var holderData = null
  var holderNode = null
...
const onMouseDragEnter = function (e, thisObj, prevObj) {
...
const onMouseDragLeave = function (e, thisObj, prevObj) {
    ...
    var element = [
      $(go.Panel, 'Vertical', {
        ...
        $(go.Panel, 'Horizontal',
          ...
          createIconHolder(),
          createTextBlock({ ...style, fontSize: '14px' }, '子主题', {
