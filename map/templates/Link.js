...
import go from 'gojs'
import { createTextBlock, makeOnewayBinding, makeTwowayBinding, createContextMenu } from '../helper'
  ...
  createTemplate(style) {
    ...
    return $(go.Link, {
      ...
      $(go.Shape, { name: 'LINE', strokeDashArray, stroke, strokeWidth },
        ...
        ...makeOnewayBinding(false, 'strokeWidth', 'stroke', 'strokeDashArray'),
      ),
    )
  }
}
...
const LineLink = {
  ...
  createTemplate(style, actionList) {
    ...
    var { fill: labelFill,
      ...
      fontColor: labelFontColor } = label
    ...
    return $(go.Link,
      {
        ...
        mouseEnter: function (e, link) {
          if (!e.diagram.isReadOnly) {
            ...
            link.findObject("HIGHLIGHT").stroke = "#FFC10733"
          }
      ...
      ...makeTwowayBinding(false, 'smoothness', 'points'),
      ...
      $(go.Shape,  // the link path shape
        ...
        // ...makeTwowayBinding(false, 'strokeWidth'),
        new go.Binding('strokeWidth', 'strokeWidth'),
        new go.Binding("strokeDashArray", "strokeDashArray"),
      ...
      $(go.Panel, "Auto",
        ...
        $(go.Shape, "RoundedRectangle",  // the label shape
          ...
          new go.Binding('visible', 'text', (text) => text && text.length > 0).ofObject('TEXT'),
